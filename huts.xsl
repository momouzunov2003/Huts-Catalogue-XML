                ...
                <xsl:for-each select="catalog/huts/hut">
                    <div>
                        ...
                        <xsl:variable name="imageSource"
                            select="unparsed-entity-uri(thumbnail/@source)" />
                        ...
                        <ul class="main-list">
                            ...
                            <li>
                                <p><b>Координати:</b><xsl:text> </xsl:text> <xsl:value-of
                                        select="./location/coordinates/latitude" /> с.ш., <xsl:text> </xsl:text><xsl:value-of
                                        select="./location/coordinates/longitude" /> и.д.</p>
                            </li>
                            <li>
                                <p><b>Надморска височина:</b><xsl:text> </xsl:text> <xsl:value-of
                                        select="./location/altitude" /> м.</p>
                            </li>
                            <li>
                                <p>
                                    <b>Контакти:</b>
                            ...
                            <li>
                                ...
                                <table border="1">
                                    ...
                                    <xsl:for-each select="exit_routes/route">
                                        <tr>
                                            <td>
                                                <xsl:value-of select="route_name" />
                                            </td>
                                            <td>
